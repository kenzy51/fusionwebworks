        ...
        <Container>
          ...
          <HalfBlock>
            ...
            <PText>
              ...
              <br />
              <strong>WE</strong> are a group of enthusiastic developers who
              decided to bring a new approach to development
              <br />
              <strong>WHAT DO WE DO?</strong>
              <br />
              <strong>WE</strong> provide high-end product quality, making it
              outstanding
              <br />
              <strong>WHAT MAKES US DIFFERENT?</strong>
              <br />
              <strong>WE</strong> bring new solutions and ideas to development,
              making it easier
            </PText>
          </HalfBlock>
        </Container>
